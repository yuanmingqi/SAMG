...
if __name__ == '__main__':
        ...
        for pkl_file in tqdm.tqdm(files):
            ...
            for i in range(len(data['samples']['success_indices'])):
                ...
                if current_size == batch_size:
                    # save the batch
                    with h5py.File(f"datasets/{tag}/processed/{flag}/bs_{batch_size}_no_{batch_idx}.h5", 'a') as hf:
                    ...
                    print(f"Saved {flag} batch {batch_idx}")
    ...
    process(all_train_files, 'train', batch_size=512)
