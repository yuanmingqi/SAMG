...
def main():
    ...
    # load data    
    data = load_h5_file("datasets/single/clip_single_dataset.h5")
    # build dataloaders
    ...
    # load model
    # yogo.module.load("logs/yogo_clip_0.8980_v5.pth", device)
    ...
    for epoch in range(num_epochs):
        ...
        if accuracy > bench:
            ...
            if os.path.exists(f"./logs/yogo_clip_{bench:.4f}_v6.pth"):
                os.remove(f"./logs/yogo_clip_{bench:.4f}_v6.pth")
            bench = accuracy
            th.save(yogo.state_dict(), f"./logs/yogo_clip_{accuracy:.4f}_v6.pth")
