...
def main():
    ...
    # load model
    yogo.module.load("logs/yogo_0.9560_bs1024_margin05_v2.pth", device)
    ...
    for epoch in range(num_epochs):
        ...
        if accuracy > bench:
            ...
            if os.path.exists(f"./logs/yogo_{bench:.4f}_v2.pth"):
                os.remove(f"./logs/yogo_{bench:.4f}_v2.pth")
            bench = accuracy
            th.save(yogo.state_dict(), f"./logs/yogo_{accuracy:.4f}_v2.pth")
