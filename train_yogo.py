...
def main():
    ...
    lr = 1e-3
    # load data
    all_data = np.load("./datasets/low/processed_data.npz", allow_pickle=True)
    ...
    for epoch in range(num_epochs):
        ...
        print(f"Epoch {epoch+1}/{num_epochs}, Train Loss: {total_loss}, Eval Accuracy: {accuracy:.4f}, Time Elapsed: {t_e - t_s:.2f}s")
